...
public class FillRestaurant{
    public static void main(String[]args){
        ...
        final String DATE = "30th July 2017";  // dining date
        
        int numBusBooked =  4;            // number of buses expected on DATE
        int numVanBooked = 3;             // number of vans expected on DATE
        ...
        int seatsleft = (MAX_OCCUPANCY -(busDiners + vanDiners) );   // Seats left for 30th July 2017
